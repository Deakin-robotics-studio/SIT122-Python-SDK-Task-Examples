...
class InteractiveGame(ALModule):
    ...
    def __init__(self, name):
        ...
        self.asr = ALProxy("ALInteractiveGame")
        ...
        self.asr.subscribe("InteractiveGame")
...
def main(ip, port):
    ...
    InteractiveGame = InteractiveGame("InteractiveGame")

    try:
        while True:
            # 100 miliseconds is an acceptable amount of input delay time.
            if InteractiveGame.quit == True:
                break
            sleep(0.1)
    except KeyboardInterrupt:
        InteractiveGame.onEnd()
        myBroker.shutdown()
